...
namespace Data_Access_Module.Daos
{
    public class CourseDAO
    {
        ...
        public SqlDataAdapter CreateDataAdapter()
        {
            ...
            insertCommand.Parameters.Add("@courseName", SqlDbType.NVarChar, 128, "CourseName");
            insertCommand.Parameters.Add("@courseCode", SqlDbType.NVarChar, 12, "CourseCode");
            ...
            updateCommand.CommandText = $"UPDATE `{this.tableName}` " +
                ...
                "AND CourseCode = @oldCourseCode ;";
            updateCommand.Parameters.Add("@courseName", SqlDbType.NVarChar, 128, "CourseName");
            updateCommand.Parameters.Add("@courseCode", SqlDbType.NVarChar, 12, "CourseCode");
            updateCommand.Parameters.Add("@id", SqlDbType.Int, 4, "Id");
            updateCommand.Parameters.Add("@oldCourseName", SqlDbType.NVarChar, 128, "CourseName").SourceVersion = DataRowVersion.Original;
            updateCommand.Parameters.Add("@oldCourseCode", SqlDbType.NVarChar, 12, "CourseCode").SourceVersion = DataRowVersion.Original;
